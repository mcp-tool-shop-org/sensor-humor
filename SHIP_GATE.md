...
- [x] `[all]` Version in manifest matches git tag (2026-09-07) — v1.3.1 at this treatment; tag cut at Phase 7
...
- [x] `[all]` Translations (polyglot-mcp, 8 languages) — regenerated via TranslateGemma 27B for v1.3.1
